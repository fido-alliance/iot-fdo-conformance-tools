...
func (h *DeviceBaseDB) GetVANDVWithWithKeys(guid fdoshared.FdoGuid, ownerPrivKey any, ownerPubKey *fdoshared.FdoPublicKey, sgType fdoshared.DeviceSgType, testid testcom.FDOTestID) (*fdoshared.DeviceCredAndVoucher, error) {
	storageId := append(h.prefix, guid[:]...)
