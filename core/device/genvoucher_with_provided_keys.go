...
func NewVirtualDeviceAndVoucherWithKeys(
	...
	negotiatedHashHmac := fdoshared.NegotiateHashHmac(newDi.DCSigInfo.SgType, sgType)

	fmt.Println("Negotiated Hash/HMAC:", negotiatedHashHmac)
	...
	var prevEntrySgType fdoshared.DeviceSgType = sgType
