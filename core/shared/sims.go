...
const (
	...
	SIM_DEVMOD_BIN = "devmod:bin"

	// OPT | UINT | URL for the Manufacturer Usage Description file that relates to this device
	SIM_DEVMOD_MUDURL = "devmod:mudurl"

	// REQ | TSTR | Number of modules supported by this FIDO Device Onboard Device
	SIM_DEVMOD_NUMMODULES = "devmod:nummodules"
	...
	SIM_DEVMOD_MODULES = "devmod:modules"
)
