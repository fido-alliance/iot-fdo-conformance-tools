...
The following example demonstrates how to do it with the conformance tools implementation.
...
The following examples show how to perform the tests using the conformance tools device implementation.
...
The following examples show how to perform the tests using the conformance tools DO implementation.

For the conformance tools implementation any private key can be provided during the test case initialization.

The downloaded voucher can then be uploaded into the db:
